...
hp_net_dict = {
    ...
    'logistic':
        {'lr': 0.04, 'batch_size': 100, 'lr_decay': ['LambdaLR', {'lr_lambda': lambda epoch: 1.0}],
         'iterations': 36000, 'momentum': 0.0, },

    'cnn':
        {'lr': 0.1, 'batch_size': 200, 'weight_decay': 0.0, 'optimizer': 'SGD', 'momentum': 0.0,
         'lr_decay': ['LambdaLR', {'lr_lambda': lambda epoch: 1.0}], 'iterations': 8000},

    'lstm':
        {'lr': 0.1, 'momentum': 0.9, 'batch_size': 200, 'weight_decay': 0.0, 'optimizer': 'SGD',
         'lr_decay': ['LambdaLR', {'lr_lambda': lambda epoch: 1.0}], 'iterations': 8000},

    'vgg11s':
        {'lr': 0.016, 'batch_size': 200, 'weight_decay': 5e-5, "momentum": 0.9,
         'lr_decay': ['LambdaLR', {'lr_lambda': lambda epoch: 1.0}], 'iterations': 36000},

    'vgg11':
        {'lr': 0.05, 'momentum': 0.9, 'batch_size': 200, 'weight_decay': 5e-4,
